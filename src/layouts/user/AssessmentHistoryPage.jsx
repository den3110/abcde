...
export default function AssessmentHistoryPage() {
  ...
  const totalPages = Math.max(1, Number(data?.totalPages || Math.ceil(total / filters.pageSize)));
                ...
                >
                  <Box>
                    ...
                    <Typography variant="body2" color="text.secondary">
                      Tổng hợp các lần admin, mod và người dùng tự chấm. Tất cả bộ lọc chạy ở
                      backend.
                    </Typography>
                  </Box>
                          ...
                          <TableRow key={row._id}>
                            ...
                            <TableCell align="center">
                              <Typography variant="body2">
                                Đơn {fmtScore(row.singleLevel)}
                              </Typography>
                              <Typography variant="body2">
                                Đôi {fmtScore(row.doubleLevel)}
                              </Typography>
                            </TableCell>
